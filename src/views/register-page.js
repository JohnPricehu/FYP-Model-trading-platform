      ...
      <div className={styles['container1']}>
        ...
        <div className={styles['container2']}>
          <div className={styles['container3']}>
            <span className={styles['text1']}>Email address</span>
            <input
              type="text"
          ...
          <span className={styles['text2']}>Username</span>
          <input
            type="text"
            placeholder="placeholder"
          ...
          <span className={styles['text4']}>Confirm Password</span>
          <input
            type="text"
            placeholder="placeholder"
          ...
          />
          <span className={styles['text5']}>Confirm Password</span>
        </div>
      </div>
      <span className={styles['text6']}>Register</span>
      <span className={styles['text7']}>Login</span>
